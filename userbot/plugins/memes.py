...
async def univsaye(cowmsg):
    """ For .cowsay module, Speedo wrapper for cow which says things. """
...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/speedoBotOP/speedoBot) to open this 🔥**Lit AF!!**🔥 __MAFIABOT__ Repo.. Join channel :- @speedoBot_Support")
...
async def react_meme(react):
    """ Make your Speedo react to everything. """
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the speedo" + "ツ")
