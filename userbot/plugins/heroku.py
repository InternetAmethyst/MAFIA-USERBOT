...
async def _(dyno):
    ...
    speedo_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": speedo_data})
        .json()
        .get("result")
        .get("key")
    )
    speedo_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{speedo_key}) && [RAW PAGE](https://nekobin.com/raw/{speedo_key}) ⚡"
