...
@Speedo.on(admin_cmd(pattern="sin ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="cos ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="tan ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="cosec ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="sec ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="cot ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="square ?(.*)"))
...
@Speedo.on(admin_cmd(pattern="cube ?(.*)"))
