...
@speedobot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="cos ?(.*)"))
@speedobot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="tan ?(.*)"))
@speedobot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="cosec ?(.*)"))
@speedobot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="sec ?(.*)"))
@speedobot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="cot ?(.*)"))
@speedobot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="square ?(.*)"))
@speedobot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@speedobot.on(admin_cmd(pattern="cube ?(.*)"))
@speedobot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
